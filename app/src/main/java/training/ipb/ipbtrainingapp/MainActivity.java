        ...
        masukButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (namaEditText.getText().toString().equals("")||
                    ...
                    Toast.makeText(MainActivity.this, "Data Masih Terdapat Yang Kosong", Toast.LENGTH_SHORT).show();
                }else{
                    nama = namaEditText.getText().toString();
                    umur = Integer.valueOf(umurEditText.getText().toString());
                    gender = genderEditText.getText().toString();
                    alamat = alamatEditText.getText().toString();
                    userData = new User(nama,umur,gender,alamat);
